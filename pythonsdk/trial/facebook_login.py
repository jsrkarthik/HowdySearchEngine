...
#access if you wanted to launch a successful production application.)
	...
	args = dict(client_id=CLIENT_ID, client_secret="dcaa2a6dd1a5c18e068d05341b572395",redirect_uri=REDIRECT_URI,
	scope=','.join(EXTENDED_PERMS), type='user_agent', display='page'
	)
	
	#webbrowser.open('https://graph.facebook.com/oauth/authorize?'+urllib.urlencode(args))
	#webbrowser.open('https://www.facebook.com/dialog/oauth?client_id=1476062702607954&redirect_uri="https://www.facebook.com/connect/login_success.html"')
